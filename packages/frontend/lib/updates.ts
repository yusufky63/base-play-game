export const SITE_UPDATES: Array<{ date: string; title: string; body: string }> = [
  {
    ...
    body: "Lucky Draw now has a flatter mobile layout, continuous reward reel, cleaner stats, better game-page order, public history, and a stricter wallet picker."
  },
  {
    date: "May 14, 2026",
