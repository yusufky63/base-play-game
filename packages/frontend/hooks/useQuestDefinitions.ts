...
export const DEFAULT_QUEST_DEFINITIONS: QuestDefinition[] = [
  ...
  { id: "daily-round-3", title: "Three-round warmup", description: "Settle three rounds today.", period: "daily", metric: "rounds", target: 3, reward_xp: 12, badge_id: null, active: true, sort_order: 15, created_at: definitionTimestamp, updated_at: definitionTimestamp },
  ...
  { id: "daily-four-games", title: "Four-game tour", description: "Settle rounds in four different games today.", period: "daily", metric: "distinct_games", target: 4, reward_xp: 22, badge_id: "daily-variety", active: true, sort_order: 44, created_at: definitionTimestamp, updated_at: definitionTimestamp },
  ...
  { id: "daily-win-3", title: "Sharp day", description: "Win three settled rounds today.", period: "daily", metric: "wins", target: 3, reward_xp: 30, badge_id: "daily-sharpshooter", active: true, sort_order: 48, created_at: definitionTimestamp, updated_at: definitionTimestamp },
  ...
  { id: "weekly-streak-3", title: "Three-day streak", description: "Keep a three day play streak this week.", period: "weekly", metric: "current_streak", target: 3, reward_xp: 35, badge_id: "streak-builder", active: true, sort_order: 68, created_at: definitionTimestamp, updated_at: definitionTimestamp },
  ...
  { id: "weekly-win-5", title: "Five-win week", description: "Win five settled rounds this week.", period: "weekly", metric: "wins", target: 5, reward_xp: 55, badge_id: "weekly-striker", active: true, sort_order: 88, created_at: definitionTimestamp, updated_at: definitionTimestamp },
  ...
  { id: "weekly-round-50", title: "50-round week", description: "Settle fifty rounds this week.", period: "weekly", metric: "rounds", target: 50, reward_xp: 120, badge_id: "weekly-marathon", active: true, sort_order: 110, created_at: definitionTimestamp, updated_at: definitionTimestamp }
];
