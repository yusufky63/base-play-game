...
const playerNotes = [
  {
    ...
    title: "Fair results",
    body: "Results are settled by contracts using verifiable randomness. The UI does not decide whether a player wins or loses."
  },
  {
  ...
  },
  {
    ...
    body: "Live feed, stats, and leaderboard data are cached briefly, refreshed in the background, and can use Supabase or on-chain fallback data."
  }
];
