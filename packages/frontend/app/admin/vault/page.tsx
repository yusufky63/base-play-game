    ...
    <AdminShell title="Vault" description="Vault health, realized P&L, payout ratio, and risk capacity. Payout values are net after house edge.">
      ...
      <div className="mt-4 grid gap-3 md:grid-cols-2">
        <div className="admin-note">
          ...
          <p className="mt-2 text-sm leading-6 text-[var(--text-2)]">
            Game pages show three quick bet buttons. They are frontend presets, not separate contract limits. Change them with <code>NEXT_PUBLIC_BET_PRESETS_ETH</code>, for example <code>0.000115,0.00023,0.0005</code>.
          </p>
